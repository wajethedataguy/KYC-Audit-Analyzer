...
@register_logic(
    name="055_position_fed_for_non_salaried_individuals",
    description="Flags non-salaried individuals where CustomerPosition is inappropriately fed, excluding ownership-related exceptions.",
    category="Compliance & Screening",
)
def logic_055_position_fed_for_non_salaried_individuals(
    ...
    try:
        ...
        if mode == "full":
            file_path = (
                f"position_fed_for_non_salaried_{datetime.now():%Y%m%d_%H%M%S}.xlsx"
            )
